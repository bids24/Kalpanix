export function applyDropdown(){
    ...
    dropdownClasses.forEach(dropdownClass => {
        ...
        dropdownClass.children[2].style.fontSize = "1rem";
        ...
        dropdownClass.children[2].style.boxShadow = "0px 10px 50px rgba(0, 0, 0, 0.8)"

        Array.from(dropdownClass.children[2].children).forEach(child => {
            child.style.borderBottom = "2px solid gray";
            child.style.borderRadius = "0.2rem";
            child.style.marginBottom = "0.3rem";
