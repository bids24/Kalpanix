    ...
    loginForms.forEach(loginForm => {
        ...
        loginForm.querySelectorAll('input[type="submit"], a').forEach(elem => {
            ...
            if (elem.type === 'submit') {
                ...
                setStyleIfNotPresent(elem, 'height', '100%');
        ...
        const applyMediaQueryStyles = () => {
            ...
            if (smallScreen.matches) {
                setStyleIfNotPresent(loginForm, 'padding', '12px');
                setStyleIfNotPresent(loginForm, 'width', '95vw'); // Max width to fit smaller screens
